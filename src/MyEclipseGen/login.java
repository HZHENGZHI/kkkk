...
public class login extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jButton2.addKeyListener(new java.awt.event.KeyAdapter() {
			public void keyPressed(java.awt.event.KeyEvent evt) {
				change_color_registered(evt);
			}
		});

		jLabel2.setText("\u5fd8\u8bb0\u5bc6\u7801");
	...
	private void change_color_registered(java.awt.event.KeyEvent evt) {
		// TODO add your handling code here:

	}

	private void change_color_login(java.awt.event.MouseEvent evt) {
		// TODO add your handling code here:

	}

	private void find_pw(java.awt.event.MouseEvent evt) throws IOException {
		new find_pw().find_pw.setVisible(true);
		System.out.println("jjsjs");
	}

	private void admin_lodin(java.awt.event.MouseEvent evt) throws IOException {
		this.dispose();
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try {
			User u = Client.lonin(user, pw);
			if (u != null) {
				this.dispose();
				System.out.println(u.acount+"    "+u.pw);
